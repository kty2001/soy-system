...
from app.routers import deblur, denoise, signal, soyanalysis, soymilk, soyvid
...
app.include_router(denoise.router, prefix="/api/denoise", tags=["Image Denoising"])
app.include_router(signal.router, prefix="/api/signal", tags=["Signal Denoising"])
